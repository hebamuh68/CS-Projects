...
class main:
    ...
    def help(self, arg, command):
        ...
        if arg not in commands:
            ...
            if arg == "cd":
                print("allows for change of the current working directory of a shell instance.")
            elif arg == "cls":
                print("clear the screen or console window of commands and any output generated by them.")
            elif arg == "dir":
                print("Displays directory of files and directories stored on disk")
            elif arg == "exit":
                print(
                    "To close or exit the Windows command line window, also referred to as command or cmd mode or DOS mode")
            elif arg == "rd":
                print("remove an empty directory on various operating systems.")
            elif arg == "md":
                print("creating a new directory")
            elif arg == "rename":
                print("changes the name of the first filename you enter to the second filename you enter.")
            elif arg == "type":
                print("displays the contents of a text file")
            elif arg == "import":
                print(
                    "Inserts data from an external file with a supported file format into a table, hierarchy, view or nickname.")
            elif arg == "export":
                print("marks an environment variable to be exported with any newly forked child processes")
            elif arg == "copy":
                print(
                    " it copies the text or image you have selected and stores is on your virtual clipboard, until it is overwritten by the next cut or copy command.")
            elif arg == "del":
