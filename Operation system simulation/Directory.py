...
class Directory(Dir_Entry):
    ...
    def update_content(self, file_name, f_name, f_attribute, f_cluster, f_size, f_empty):
        Directory(f_name, f_attribute, f_cluster, f_size, f_empty)
...
dobj = Directory("file1", "0x0", 6, 20, "heba")
